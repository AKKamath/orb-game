...
func _on_orb_clicked(index: Vector2i, clicked: bool, dragged : bool) -> void:
	print(curOrb, clicked, dragged)
	if curOrb == null and clicked:
		curOrb = index
